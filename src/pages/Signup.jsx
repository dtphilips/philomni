...
export default function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      // Create user profile row immediately
      if (data.user) {
      ...
      // If email confirmation is disabled in Supabase, go directly to onboarding
      if (data.session) {
        navigate('/onboarding');
      } else {
        setStep('verify');
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold font-display">Join Philomni</h1>
          <p className="text-muted-foreground text-sm mt-1">Brilliance Deserves a Home.</p>
        </div>
