          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              {members.map(m => {
                ...
                const displayName = m.user_id === user?.id ? 'You' : (memberUser.full_name || memberUser.username || 'Member')
                return (
                <div key={m.id} className="flex items-center gap-2.5 px-4 py-2 hover:bg-muted/50 group/member">
                  <div className="relative flex-shrink-0">
                    <Avatar src={memberUser.avatar_url || null} name={memberUser.full_name || 'Member'} size={8} />
